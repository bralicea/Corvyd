...
class GateOB(Gate):
    ...
    def onOpen(self):
        params = {
            ...
            "params": [[pair, 20, "0"] for pair in base.instruments.instruments['gate']]
        }
        subscription = base.json.dumps(params)
        self.sendMessage(subscription.encode('utf8'))
    ...
    def onMessage(self, payload, isBinary):
        self.producer.send('gateOrderBooks', payload)


base.createConnection("wss://ws.gate.io/v3/", 443, Gate)
base.createConnection("wss://ws.gate.io/v3/", 443, GateOB)
